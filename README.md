...
<a href="https://github.com/pulibrary/ExcelAlmaLookup/releases/download/v1.3.0-beta/CatalogLookupInstaller.exe">CatalogLookupInstaller.exe</a>
...
The user is now interested in looking up the OCLC numbers that were just retrieved in order to check the WorldCat holdings.  They highlight column D, and click the "Look Up in Catalog" button again.  
