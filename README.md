...
<ol>
 ...
 <li>Select or enter the fields to be extracted in the "Result type" menu.  Multiple fields may be included, using the "Add" button to the right of the list.  </li>
