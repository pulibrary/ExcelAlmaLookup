...
<ol>
 ...
 <li>If not already set, enter your institution's Alma SRU Base URL (or, to search WorldCat, click "Non-Alma Sources" and select "source:worldcat".  See "<a href='#configuration'>Configuration</a>" section below for more information.)</li>
